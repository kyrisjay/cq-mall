...
public class PmsProductCategoryResp {
    /**
     * id : 1
     * parentId : null
     * name : 服装
    ...
    private List<PmsProductCategoryResp>  children;
    ...
    public List<PmsProductCategoryResp> getChildren() {
        return children;
    }

    public void setChildren(List<PmsProductCategoryResp> children) {
